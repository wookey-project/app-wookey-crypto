...
/* FIXME: [RB] rewrite this basic TDES implementation and move it
 * to the more appropriate libs location, with optional hardware
 * accelerated TDES abstraction support as it is done for
 * AES.
 */
...
static inline int des_main_ks( uint32_t SK[32], uint8_t key[8] )
{
    int i;
    uint32_t X, Y, T;
...
static inline int des_set_key( des_context *ctx, uint8_t key[8] )
{
    int i;
...
static inline void des_crypt( uint32_t SK[32], uint8_t input[8], uint8_t output[8] )
{
    uint32_t X, Y, T;
...
static inline void des_encrypt( des_context *ctx, uint8_t input[8], uint8_t output[8] )
{
    des_crypt( ctx->esk, input, output );
}

static inline void des_decrypt( des_context *ctx, uint8_t input[8], uint8_t output[8] )
{
...
static inline int des3_set_2keys( des3_context *ctx, uint8_t key1[8], uint8_t key2[8] )
{
    int i;
...
static inline int des3_set_3keys( des3_context *ctx, uint8_t key1[8], uint8_t key2[8],
                                       uint8_t key3[8] )
{
    int i;
...
static inline void des3_crypt( uint32_t SK[96], uint8_t input[8], uint8_t output[8] )
{
    uint32_t X, Y, T;
...
static inline void des3_encrypt( des3_context *ctx, uint8_t input[8], uint8_t output[8] )
{
    des3_crypt( ctx->esk, input, output );
}

static inline void des3_decrypt( des3_context *ctx, uint8_t input[8], uint8_t output[8] )
{
